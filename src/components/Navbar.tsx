...
//     <div
//       ref={navRef}
//   className="fixed top-4 left-1/2 -translate-x-1/2 lg:w-3/4 w-full h-20 bg-black/70 backdrop-blur-xl z-50 lg:rounded-4xl"
//     >
...
//         {/* Desktop Button */}
//         <button className="hidden md:block bg-orange-500 px-4 py-2 rounded-lg hover:scale-105 transition">
//           Get Started
//         </button>
...
//       <div
//         ref={mobileMenuRef}
//         className="md:hidden overflow-hidden h-0 opacity-0 bg-black/90 backdrop-blur-lg"
//       >
//         <div className="flex flex-col items-center gap-6 py-6 text-white">
//           <Link onClick={() => setOpen(false)} to="/">Home</Link>
//           <Link onClick={() => setOpen(false)} to="/">Services</Link>
//           <Link onClick={() => setOpen(false)} to="/">Contact</Link>
//           <Link onClick={() => setOpen(false)} to="/">About Us</Link>
